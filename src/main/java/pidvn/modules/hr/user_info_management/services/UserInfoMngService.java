...
import pidvn.mappers.one.hr.user_info_management.UserInfoMngMapper;
...
@Service
public class UserInfoMngService implements IUserInfoMngService {

    @Autowired
    private UserInfoMngMapper userInfoMngMapper;
    ...
    @Override
    public List<UserInfoVo> getUsers(UserInfoVo searchVo) {

        List<UserInfoVo> users = this.userInfoMngMapper.getUsers(searchVo);
    ...
    public Map getUserInfo(String username) {
        ...
        List<UserInfoVo> userBasicInfo = this.userInfoMngMapper.getBasicUserInfo(username);
    ...
    @Override
    public void deleteUserFile(Integer id) {
        UserFile userFile = this.userFileRepo.findById(id).get();
        ...
        this.userFileRepo.delete(userFile);
    }
